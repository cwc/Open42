...
public class DominoTest {
	...
	public final void testToString() {
		assertTrue("Initial setup domino is a blank-blank", testDomino.toString().equals("0/0"));
		
		testDomino.setSide0(4);
		testDomino.setSide1(3);
		
		assertTrue("Domino is now a four-three", testDomino.toString().equals("4/3"));
	}
	...
	public final void testIsDouble() {
		assertTrue("Initial setup domino is a blank-blank", testDomino.isDouble());
